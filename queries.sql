...
-- More Narrow Search for Retirement Eligibility
...
-- Dropping retirement_info table in order to add emp_no to it
...
-- Sales Team Employee Retirement Information Only
...
-- Sales & Development Teams Employee Retirement Information Only

SELECT ri.emp_no,
	ri.first_name,
	ri.last_name,
	d.dept_name
INTO sales_Development_teams_emp_info
FROM retirement_info as ri
INNER JOIN dept_emp as de
ON (ri.emp_no = de.emp_no)
INNER JOIN departments AS d
